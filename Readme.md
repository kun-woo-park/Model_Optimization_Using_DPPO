...
본 Repo는 [Imitation_learning](https://github.com/kun-woo-park/Imitation_learning)에서 이어지는 내용이다. 학습된 supervised learning model을 기반으로 DPPO알고리즘을 통해 fine tuning을 진행하였다. 최종 결과들은 [심층 강화학습을 이용한 항공기 충돌회피 모델링 및 모델 최적화.pdf](심층%20강화학습을%20이용한%20항공기%20충돌회피%20모델링%20및%20모델%20최적화.pdf)에서 작성된 논문 내용을 확인할 수 있다. 정리되지 않은 실험내용은 [Aircraft_avoidance_RL](https://github.com/aisl-khu/collision_avoidance/tree/master/Aircraft_avoidance_RL)에서 확인할 수 있다.
